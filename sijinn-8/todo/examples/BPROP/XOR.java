...
//		final ITrainingStrategy trainingStrategy = new StochasticGradientDescent(new BPROP(learningRate,learningMomentum), new MSE());
		final ITrainingStrategy trainingStrategy = new OnlineGradientDescent(new BPROP(learningRate,learningMomentum), new MSE());
//		final ITrainingStrategy trainingStrategy = new DeferredGradientDescent(new BPROP(learningRate,learningMomentum), new MSE(),0);
