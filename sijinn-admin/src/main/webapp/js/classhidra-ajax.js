...
var clajax = function(prot){
	...
	this.setRel = function(_rel){
		this.rel = _rel;
		return this;
	}
	
	this.setMedia = function(_media){
		this.media = _media;
		return this;
	}	
	
	this.setResponseType = function(_responseType){
		this.responseType = _responseType;
		return this;
	}
	
	this.setContentEncoding = function(_contentEncoding){
		this.contentEncoding = _contentEncoding;
		return this;
	}
	
	this.setContentType = function(_contentType){
	...
	this.setRedy = function(_ready){
		this.ready = _ready;
		return this;
	}	
	
	this.setFail = function(_fail){
		this.fail = _fail;
		return this;
	}	
	...
	this.setFinish = function(_finish){
		this.finish = _finish;
		return this;
	}	
	
	this.setBase64 = function(_base64){
		this.base64 = _base64;
		return this;
	}
	
	this.setAsJson = function(_asJson){
		this.asJson = _asJson;
		return this;
	}	
	
	this.setAsXml = function(_asXml){
		this.asXml = _asXml;
		return this;
	}	

	this.setAsMpart = function(_asMpart){
		this.asMpart = _asMpart;
		return this;
	}	
	
	this.setAsScript = function(_asScript){
		this.asScript = _asScript;
		return this;
	}	
	
	this.setAsCss = function(_asCss){
		this.asCss = _asCss;
		return this;
	}		
	...
	this.submit = function(_form, _action){
		if(_form)
			this.form = _form;
	...
	this.getParametersAsJson = function(frm,_url) {
	    var issue;
	...
	this.getParametersAsMpart = function(frm,_url) {
