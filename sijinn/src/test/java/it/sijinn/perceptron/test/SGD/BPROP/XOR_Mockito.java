package it.sijinn.perceptron.test.SGD.BPROP;
...
public class XOR_Mockito {
  ...
  public void backPropagation() throws Exception {
	  ...
	  when(network.obtainCloned()).thenReturn(new Network().open(new ResourceStreamWrapper("it/sijinn/perceptron/test/resources/XOR_init.net")));
	  
	  	network = network.obtainCloned();
